...
export default function MultiStepForm() {
  ...
  const renderStepContent = () => {
    switch (step) {
      case 0:
        return <PersonalInfoStep register={register} control={control} errors={errors} />
      case 1:
        return <AddressStep register={register} control={control} errors={errors} />
      case 2:
        return <EmploymentStep register={register} control={control} errors={errors} />
      case 3:
        return <LoanSpecificationsStep register={register} control={control} errors={errors} />
      case 4:
    ...
    return (
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-end space-y-4 sm:space-y-0 sm:space-x-4 mt-8">
          <Button onClick={() => setIsPreview(false)} variant="outline" className="px-6 py-3">
            Back to Edit
          </Button>
          <AlertDialog>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col md:flex-row">
      {/* Sidebar */}
      <div
        className={`${isSidebarOpen ? "w-full md:w-72" : "w-20"} bg-gradient-to-b from-primary to-primary/80 text-primary-foreground shadow-lg transition-all duration-300`}
      >
        <button
        ...
        <Card className="max-w-4xl mx-auto">
          <CardContent className="p-6">
            <div className="mb-6">
              ...
              {!isPreview && <p className="text-muted-foreground">Step {step + 1} of 8</p>}
            </div>
