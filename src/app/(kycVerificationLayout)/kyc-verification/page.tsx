...
const formSchema = z.object({
    ...
    documentType: z.enum(["NATIONAL_ID", "PASSPORT", "DRIVING_LICENSE", "VOTER_ID"], {
        required_error: "Please select a document type.",
    }),
    documentNumber: z.string().min(1, { message: "Document number is required." }),
    documentFrontUrl: z.string().min(1, { message: "Front document image is required." }),
    ...
    addressProofUrl: z.string().min(1, { message: "Address proof document is required." }),
...
export default function KycVerificationPage() {
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>, field: any, setPreview: (url: string) => void) => {
    ...
    const nextStep = async () => {
        const fieldsToValidate = {
            ...
            3: ["addressLine1", "city", "state", "postalCode", "country", "addressProofUrl"],
        }[step]
    ...
    async function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        try {
            ...
            alert("There was an error submitting your KYC verification. Please try again.")
        } finally {
                        ...
                        {Array.from({ length: totalSteps }).map((_, i) => (
                            <div key={i} className="flex flex-col items-center">
                                ...
                                <span className="text-xs mt-1 text-muted-foreground">
                                    {i === 0 ? "Personal" : i === 1 ? "Document" : i === 2 ? "Address" : "Selfie"}
                                </span>
                            </div>
                        ))}
                    </div>
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value={UserProfileGender.MALE}>Male</SelectItem>
                                                            <SelectItem value={UserProfileGender.FEMALE}>Female</SelectItem>
                                                            <SelectItem value={UserProfileGender.OTHER}>Other</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                    <FormMessage />
                                                </FormItem>
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                        ...
                                                        <SelectContent>
                                                            <SelectItem value={DocumentType.NATIONAL_ID}>National ID</SelectItem>
                                                            ...
                                                            <SelectItem value={DocumentType.VOTER_ID}>Voter ID</SelectItem>
                                                        </SelectContent>
                                                    </Select>
                                                    <FormMessage />
                                                </FormItem>
                                                        ...
                                                        <div className="flex flex-col items-center">
                                                            ...
                                                            >
                                                                ...
                                                                <input
                                                                    ...
                                                                    accept="image/*"
                                                                    className="hidden"
                                                                    onChange={(e) => handleFileUpload(e, field, setDocumentFrontPreview)}
                                                                />
                                                            </label>
                                                        </div>
                                                    </FormControl>
                                                        ...
                                                        <div className="flex flex-col items-center">
                                                            ...
                                                            >
                                                                ...
                                                                <input
                                                                    ...
                                                                    accept="image/*"
                                                                    className="hidden"
                                                                    onChange={(e) => handleFileUpload(e, field, setDocumentBackPreview)}
                                                                />
                                                            </label>
                                                        </div>
                                                    </FormControl>
                                                ...
                                                <FormControl>
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        >
                                                            {addressProofPreview ? (
                                                                <img
                                                                    src={addressProofPreview || "/placeholder.svg"}
                                                            ...
                                                            <input
                                                                ...
                                                                accept="image/*,.pdf"
                                                                className="hidden"
                                                                onChange={(e) => handleFileUpload(e, field, setAddressProofPreview)}
                                                            />
                                                        </label>
                                                    </div>
                                                </FormControl>
                                ...
                                <div className="space-y-4">
                                                    ...
                                                    <div className="flex flex-col items-center">
                                                        ...
                                                        >
                                                            ...
                                                            <input
                                                                ...
                                                                accept="image/*"
                                                                className="hidden"
                                                                onChange={(e) => handleFileUpload(e, field, setSelfiePreview)}
                                                            />
                                                        </label>
                                                    </div>
                                                </FormControl>
                                    ...
                                    <div className="p-4 bg-muted rounded-lg">
                                        <p className="text-sm">
                                            ...
                                            Providing false information may result in account termination and possible legal consequences.
                                        </p>
                                    </div>
                                </div>
                            )}
